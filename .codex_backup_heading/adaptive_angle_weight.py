...
import numpy as np
import math
from tracking.angle_feature import resolve_sigma_value
...
def compute_adaptive_cost_matrix_weights(track_angles, det_angles, 
    ...
    Args:
        ...
        angle_sigma: 高斯方法的标准差，可为标量、[n_tracks]向量或[n_tracks, n_dets]矩阵
        verbose: 是否打印调试信息
    ...
    for t in range(n_tracks):
        for d in range(n_dets):
            ...
            adaptive_angle_weight = compute_adaptive_angle_weight(
                ...
                sigma=resolve_sigma_value(angle_sigma, t, d)
            )
